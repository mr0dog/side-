...
isonground = False
offset = 0
music = pygame.mixer.music.load('run song.mp3')
...
running = True
def draw_clouds():
    for x in range(-1000, 80000, 300): #this loop controls WHERE and HOW MANY clouds are drawn
    ...
    pygame.draw.rect(screen, (244,255,255), (x - 50 + offset, 100, 100, 65)) #flatten bottom edge
        # draw trees
def draw_trees():
    for x in range(-500000, 80000, 300):
         for i in range(3):
